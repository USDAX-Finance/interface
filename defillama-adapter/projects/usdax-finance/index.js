...
// Contract: APXStaking — Synthetix rewardPerToken model
// TVL = APX actively staked by users (excludes protocol-owned reward pool)
...
module.exports = {
  methodology:
    ...
    "Only the active stake (accruing rewards) is counted — cooldown positions and the protocol reward pool are excluded.",
  robinhoodchain: {
    tvl,
    staking: tvl,
  },
